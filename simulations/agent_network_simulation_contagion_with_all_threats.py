...
resource_threats_csv = "../personnel_risk/resource_threats.csv"  
pattern_threats_csv = "../security_threats/design_threats.csv"    
SLA_csv = "../sla_policies/SLA.csv"                             
node_threat_map_csv = "../threat_maps/node_threat_map.csv" 
