...
# the application piece separate from the LLM output, possibly to layer in 
# deterministic up/down measures on the application node and 
# the error policy to the LLM output node.
